    ...
    <div class="container-fluid">
        <div class="row mt-3 px-2">
            <div class="col-sm-10 rounded border mx-auto p-3 shadow">
                <h5 class="text-center">Consulta de Ordem de serviços</h5>
                        ...
                        <tbody>
                            ...
                            foreach($dados_servico as $value)
                            {
                                echo "<tr>
                                        ...
                                        <td>
                                        <a href='". URL ."excluir-servico/$value->cod_servico' onclick='return confirm(\"Tem certeza?\")' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i> Excluir</a>
                                        <a href='". URL ."editar-servico/$value->cod_servico' class='btn btn-warning btn-sm'><i class='fa fa-edit'></i> Editar</a>
